...
export const Projects = memo(function Projects() {
  ...
  return (
    <div className="space-y-2.5">
      {state === 'error' && (
        <div className="text-neutral-400">warn: could not reach github, showing pinned repos</div>
      )}
      {list.map((r) => {
        ...
        return (
          <div key={r.id}>
            <div className="flex flex-wrap items-center gap-x-2.5 gap-y-1">
              ...
              <a href={r.html_url} target="_blank" rel="noreferrer" className="font-medium text-neutral-100 underline-offset-4 hover:underline">
                {r.name}
              </a>
              {r.language && (
            ...
            <div className="pl-1 text-xs text-neutral-500">
      ...
      {state === 'error' && (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-block text-neutral-100 underline-offset-4 hover:underline"
        >
          view all on github↗
        </a>
      )}
