        ...
        {open && (
          ...
          >
            <div className="px-6 py-4 flex flex-col gap-4">
              ...
              <Link href="/terminal" className="text-sm text-neutral-600 hover:text-neutral-900">
                Terminal
              </Link>
            </div>
          </motion.div>
    ...
    <footer className="border-t border-neutral-200 bg-white py-10">
      <div className={`${CONTAINER} flex flex-wrap items-center justify-between gap-4 text-xs text-neutral-500`}>
        ...
        <div className="flex items-center gap-6">
          ...
          <Link href="/terminal" className="underline underline-offset-4 hover:text-neutral-900">Terminal</Link>
        </div>
      </div>
    </footer>
  )
